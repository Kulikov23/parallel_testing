Feature: Lookup a definition 3
  In order to talk better
  As an English student
  I want to look up word definitions

  Scenario: 3.0001 Looking up the definition of 'apple'
    Given the user is on the Wikionary home page
    When the user looks up the definition of the word 'apple'
    Then they should see the definition 'A common, round fruit produced by the tree Malus domestica, cultivated in temperate climates.'

  Scenario: 3.0002 Looking up the definition of 'pear'
    Given the user is on the Wikionary home page
    When the user looks up the definition of the word 'pear'
    Then they should see the definition 'An edible fruit produced by the pear tree, similar to an apple but elongated towards the stem.'

  Scenario: 3.0003 Looking up the definition of 'java'
    Given the user is on the Wikionary home page
  ...
  Scenario: 3.0004 Looking up the definition of 'automation'
    Given the user is on the Wikionary home page
  ...
  Scenario: 3.0005 Looking up the definition of 'aim'
    Given the user is on the Wikionary home page
  ...
  Scenario: 3.0006 Looking up the definition of 'parallelism'
    Given the user is on the Wikionary home page
